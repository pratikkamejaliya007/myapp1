...
const ProductCard = ({ data, addbagdata, isAdded }) => {
            ...
            <div className="flex flex-col justify-between">
              <div className="flex flex-col relative overflow-hidden h-[100px]">
                ...
                <div id="slide" className="mt-4 absolute w-full bg-white">
                  <button
                    className={`flex items-center justify-center px-10 mx-auto mb-2 py-2 border rounded-md text-gray-700 border-gray-300 ${isAdded ? 'bg-gray-300 cursor-not-allowed' : 'hover:bg-pink-500 hover:text-white'}`}
                    onClick={() => addbagdata(data.id)}
                    disabled={isAdded}
                  >
